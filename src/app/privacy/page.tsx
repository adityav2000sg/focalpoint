...
export default function PrivacyPage() {
  return <LegalPage eyebrow="Privacy" title="Your finances deserve plain language.">
    ...
    <p>AI is off by default. If you enable it, text questions and the financial context needed to answer them may be sent to the configured Qwen service. Voice capture sends the recording and your chosen pronunciation vocabulary for transcription. Lifetime does not allow AI to move money or change a record without your review.</p>
    <h2>Your controls</h2>
